...
class Application():
    ...
    def recolher(self):
        self.imgrecolher = PhotoImage(file="fundo.png")
    ...
    def newpage(self):
        ...
        try:
            ...
            messagebox.showerror(title="ERRO", message="Preço deve conter somente números, EX: R$10.50")

        try:
            placa = str(self.placa_entry.get()).strip()
            if len(placa) != 7:
                placa = 1
            placa.upper()
        except:
            messagebox.showerror(title="ERRO", message="A Placa deve conter 7 caracteres")

        try:
            hora_inicial = int(self.horas1_entry.get())
        except:
            messagebox.showerror(title="ERRO", message="Hora Inicial Deve Ser Um Número INTEIRO")
        try:
            hora_final = int(self.horas2_entry.get())
        except:
            messagebox.showerror(title="ERRO", message="Hora Final Deve Ser Um Número INTEIRO")
        ...
        try:
            ...
            messagebox.showerror(title="ERRO", message="Hora de entrada ou saída Não Deve Ultrapassar 24 horas")
        ...
        try:
            ...
            messagebox.showerror(title="ERRO", message="Hora Final Deve Ser SUPERIOR a Hora De Entrada")
    ...
    def widgets(self):
        ...
        #Carro
        self.estilo = PhotoImage(file="car1.png")
